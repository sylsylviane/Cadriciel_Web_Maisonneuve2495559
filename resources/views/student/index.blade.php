@extends('layouts.app')
@section('title', trans('Étudiants'))
@section('content')
<div class=" mx-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-3 bg-body-tertiary rounded-3">
            <li class="breadcrumb-item"><a href="{{route('accueil')}}" class="text-dark text-decoration-none">@lang('Accueil')</a></li>
            <li class="breadcrumb-item active text-dark fw-semibold" aria-current="page">@lang('Étudiants')</li>
        </ol>
    </nav>
</div>
        ...
        <div class="card text-center border-0 shadow rounded-0 p-4 m-2">
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-center">
                    <a href="{{route('student.show', $student->id)}}" class="btn btn-sm px-5 py-2 text-primary-emphasis bg-primary-subtle border border-primary-subtle rounded-3 ">@lang('Voir')</a>
                </div>
            </div>
        </div>
    </div>
